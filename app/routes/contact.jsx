  ...
  return (
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-2">
                    ...
                    {isDropdownOpen && (
                      <div className="absolute flex top-1 right-3 mt-2 w-48 px-20 py-5">
                        <ul className="flex flex-col px-4 py-3 md:p-0 mt-4 font-medium rounded-lg md:flex-row md:space-x-8 md:mt-0 bg-black">
                          <li>
                            <a href="/allposts" className="w-full block pl-3 pr-4 text-white md:bg-transparent md:p-0 hover:text-blue-600">PROPERTIES</a>
                          </li>
                          <li>
                            <a href="/contact" className="block pl-3 pr-4 text-white md:bg-transparent md:p-0 hover:text-blue-600">CONTACT</a>
                          </li>
                        </ul>
                      </div>
                    )}
                  ...
                  <div className="items-center hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-black md:bg-black">
                      <li>
                        <a href="/allposts" className="text-2xl font-semibold whitespace-nowrap text-white hover:text-blue-600">PROPERTIES</a>
                      </li>
                      <li>
                      <a href="/contact" className="text-2xl font-semibold whitespace-nowrap text-white hover:text-blue-600">CONTACT</a>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <main>
      ...
      <form onSubmit={handleSubmit} className="w-full lg:w-2/3 mx-auto p-5">
        ...
        <button
          type="submit"
          className="bg-black text-white py-2 px-4 rounded hover:bg-gray-700 focus:outline-none transform transition-transform hover:scale-110 hover:bg-blue-600"
        >
          Send Message
        </button>
      </form>
