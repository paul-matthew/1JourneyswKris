            ...
            <nav className="bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-600">
              ...
              <div className="md:hidden flex md:order-2 relative dropdown-container">
                ...
                {isDropdownOpen && (
                  ...
                  <ul className="flex flex-col px-4 py-3 md:p-0 mt-4 font-medium rounded-lg md:flex-row md:space-x-8 md:mt-0 bg-gray-300 bg-opacity-100">
                    <li>
                      <a href="/allposts" className="w-full block pl-3 pr-4 text-blue-500 md:bg-transparent md:p-0 ">POSTS</a>
                    </li>
                    <li>
                      <a href="/contact" className="block pl-3 pr-4 text-blue-500 md:bg-transparent md:p-0">CONTACT</a>
                    </li>
                  </ul>
                </div>
                )}
