        ...
        <section id='posts' ref={sectionRef} className="bg-white">
          <div className="container px-5 py-24 mx-auto text-black">
            ...
            <div className="justify-center flex flex-center">
              <button className="bottom-36 right-8 bg-black hover:bg-purple-600 transform transition-transform hover:scale-110 text-white font-bold py-3 px-6 rounded-md shadow-xl transform z-20">
                <a href='/allposts'>All Properties</a>
              </button>
            </div>
          </div>
        </section>
